        ...
        <div class="container">
            ...
            <div class="wrap-slick2">
				...
				<div class="slick2 slick-initialized slick-slider">
                        <div class="slick-list draggable">
                            <div class="slick-track" style="opacity: 1; width: 2120px; transform: translate3d(0px, 0px, 0px);">
                             @foreach ($products as $product)  
                            <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15 slick-slide slick-current slick-active" tabindex="0" style="width: 265px;" data-slick-index="0" aria-hidden="false">
                                <div class="block2">
                                    ...
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            <a href="/san-pham/{{ $product->id }}-{{ Str::slug($product->name,'-') }}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" tabindex="0">
                                                {{ $product->name }}
                                            </a>
