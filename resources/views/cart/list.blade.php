...
@section('content')
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    @foreach($products as $key => $product)
                                        @php
                                            ...
                                            $priceEnd = $price * $carts[$product->id]; //tong tien cua 1 san pham
                                            $total += $priceEnd; // tong tien cua tat ca cac san pham
                                        @endphp
                                        <tr class="table_row">
                                            <td class="column-1">
    ...
    @else
        <div class="text-center"><h2>Chưa có sản phẩm</h2></div>
    @endif
@endsection
