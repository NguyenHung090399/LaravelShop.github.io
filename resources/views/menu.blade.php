...
<div class="container">
    ...
    <div class="row isotope-grid" style="position: relative; height: 1721.62px;hidden:none">
        @include('product.list')
    </div> 
    <div class="card-footer clearfix" style="margin-bottom: 50px; background:none ;">
        {!! $products->links() !!}
    </div>
</div>
@endsection